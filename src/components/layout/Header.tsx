        ...
        <nav className="mx-auto max-w-[1680px] px-[140px]">
          ...
          <ul className="nav-primary flex gap-10">
            ...
            <li className="group relative flex-1">
              ...
              >
                <span className="pointer-events-none absolute left-0 top-0 h-px w-[calc(100%-52px)] bg-white/[0.18]" />
                <span className="nav-primary__main-link__line pointer-events-none absolute left-0 top-0 h-[2px] w-[calc(100%-52px)] origin-left scale-x-0 bg-white/70 transition-transform duration-500 ease-[cubic-bezier(0.25,0.74,0.22,0.99)] group-hover:scale-x-100" />

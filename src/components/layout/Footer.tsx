...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-[#394854]">
      <div className="container-h pt-16 md:pt-20 lg:pt-24">
        <div className="grid min-h-[340px] grid-cols-1 gap-14 pb-20 md:grid-cols-[1fr_1fr_auto] md:gap-10 lg:pb-28">
          <div>
            <div className="mb-10 flex items-center gap-2.5">
              <a
                href="https://www.linkedin.com/company/11195107"
                aria-label="LinkedIn"
                className="flex h-7 w-7 items-center justify-center rounded-[3px] bg-[#435465] text-white transition-colors hover:bg-[#354555]"
                target="_blank"
            ...
            <div className="text-[18px] tracking-[-0.03em] text-[#435465] md:text-[20px]">
          ...
          <nav className="md:justify-self-start lg:justify-self-center">
            <ul className="space-y-1">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[16px] leading-[1.6] tracking-[-0.03em] text-[#394854] transition-colors hover:text-[#b4042f]"
                  >
          ...
          <div className="flex md:justify-end md:items-start">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full bg-[#f6f6f7] text-[#394854]/45 transition-colors hover:text-[#394854]"
            >
        ...
        <div className="flex flex-col gap-4 py-8 text-[14px] leading-none tracking-[-0.02em] text-[#435465]/55 md:flex-row md:items-center md:justify-between">

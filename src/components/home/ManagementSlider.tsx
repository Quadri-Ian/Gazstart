...
export default function ManagementSlider() {
  ...
  return (
    <section className="ui-dark-background overflow-hidden pt-12 md:pt-20" id="ceo">
          ...
          <div className="relative min-h-[660px] overflow-hidden bg-[#1e2731] md:min-h-[780px]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3 className="absolute bottom-6 left-[62%] z-20 max-w-[460px] -translate-x-1/2 text-[66px] font-normal leading-[0.92] tracking-[-0.06em] text-white md:bottom-10 md:text-[98px]">
                  {person.name[0]}
                  <br />
                  {person.name[1]}
                </h3>
            ...
            <div className="flex h-full flex-col justify-between pt-16">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="max-w-[420px] lg:ml-auto lg:mr-[6%] lg:mt-[12%]"
                >
              ...
              <div className="mt-12 flex items-end justify-between gap-6 pb-10">

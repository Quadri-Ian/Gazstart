...
export default function ManagementSlider() {
  ...
  return (
    <section className="ui-dark-background overflow-hidden pt-0" id="ceo">
      <div className="ml-auto w-[calc(100%-max(20px,calc((100vw-1680px)/2+30px)))] sm:w-[calc(100%-max(60px,calc((100vw-1680px)/2+60px)))] lg:w-[calc(100%-max(140px,calc((100vw-1680px)/2+140px)))]">
        <div className="grid grid-cols-1 overflow-hidden lg:grid-cols-[minmax(0,0.49fr)_minmax(0,0.51fr)]">
          <div className="relative min-h-[660px] overflow-hidden bg-[#1e2731] md:min-h-[780px]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3 className="absolute bottom-6 right-4 z-30 max-w-[320px] text-right text-[52px] font-normal leading-[0.92] tracking-[-0.06em] text-white md:bottom-10 md:right-6 md:max-w-[400px] md:text-[78px] lg:right-8 lg:max-w-[430px] lg:text-[88px]">
                  {person.name[0]}
                  <br />
                  {person.name[1]}
                </h3>
          ...
          <div className="relative min-h-[660px] bg-primary-600 px-8 py-12 text-white md:min-h-[780px] md:px-14 md:py-16 lg:pr-[84px]">
            <div className="title-border border-white/16">
              <h2 className="text-[18px] md:text-[22px]">{t("managementTitle")}</h2>
            </div>
            ...
            <div className="flex h-full flex-col justify-between pt-16">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="max-w-[390px] lg:ml-auto lg:mr-[6%] lg:mt-[10%]"
                >
                  <svg width="34" height="28" viewBox="0 0 46 40" fill="none" aria-hidden="true" className="mb-6 text-white">
                  ...
                  <p className="text-[17px] leading-[1.36] tracking-[-0.02em] text-white md:text-[20px]">
                    {person.quote}
                  </p>
                  <Link
                    href={`/${locale}${person.href}`}
                    className="mt-8 inline-flex items-center gap-4 text-[14px] text-white transition-opacity duration-300 hover:opacity-80"
                  >

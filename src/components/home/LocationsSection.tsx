  ...
  return (
    <section className="ui-dark-background py-28 md:py-36" id="geography">
      <div className="container-h">
        ...
        <ScrollReveal className="relative min-h-[560px] pt-6 md:min-h-[660px]">
          <div className="absolute right-0 top-[154px] h-[300px] w-[48%] overflow-hidden bg-white/10 md:top-[132px] md:h-[386px]">
            <Image
              src={introBackground}
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(57,72,84,0.08)_0%,rgba(57,72,84,0.16)_100%)]" />
          ...
          <div className="absolute left-0 right-[14%] top-[168px] h-px bg-white/14" />
          <div className="absolute left-[27%] top-[168px] z-20 h-[64px] w-[64px] rounded-full bg-primary-600 md:h-[66px] md:w-[66px]" />
          <div className="absolute left-[50.5%] right-[0%] top-[84px] z-20 h-px bg-white/14" />
          <div className="absolute left-[50.5%] top-[84px] z-20 h-[10px] w-[10px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white" />

          <svg viewBox="0 0 980 440" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute bottom-[92px] left-[18%] z-10 h-[330px] w-[78%] opacity-95 md:bottom-[96px] md:h-[390px]" aria-hidden="true">
          ...
          <div className="absolute left-[51%] top-[84px] z-20 h-[160px] w-[160px] rounded-full bg-primary-600/95 md:h-[320px] md:w-[320px]" />

          <div className="absolute left-0 top-[150px] z-20 max-w-[180px] text-white">
          ...
          <Link
            ...
            className="absolute bottom-[112px] left-0 z-20 inline-flex items-center gap-4 text-[15px] text-white transition-opacity duration-300 hover:opacity-80"
          >
